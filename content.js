    ...
    milestones: [
      {
        ...
        body: "I started by exploring how good digital products are built, then turned that curiosity into hands-on projects across web, AI tools, and problem solving.",
      },
      {
        year: "02",
        phase: "Projects",
        title: "Building practical projects",
        body: "I focus on creating useful, clean, and understandable work: portfolio sites, web apps, automation ideas, and projects that solve real user needs.",
      },
      {
        year: "03",
        phase: "Skills",
        title: "Learning by shipping",
        body: "Every project helps me sharpen how I plan, build, test, explain, and improve. I value clear execution as much as the final result.",
      },
      {
        year: "04",
        phase: "Goal",
        title: "Open to opportunities",
        body: "I'm looking for roles, internships, and collaborations where I can contribute, learn quickly, and keep building meaningful digital experiences.",
      },
    ],
  },
